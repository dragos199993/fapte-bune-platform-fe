        ...
        <div className="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="hero-text col-span-6">
            <Heading className="max-w-xl">
              Vrei sa ajuti comunitatea si sa schimbi o viata?
            </Heading>
            <Divider className="w-12" />
            <p className="text-dark dark:text-light text-base leading-relaxed mt-8 font-semibold">
              Noi iti oferim platforma prin care sa o faci
            </p>
            <div className="get-app flex space-x-5 mt-10 justify-center md:justify-start">
              <button className="apple bg-light shadow-md px-3 py-2 rounded-lg flex items-center space-x-4">
                <div className="logo">
                  <svg
                    className="w-6 h-6"
              ...
              <button className="google bg-light shadow-md px-3 py-2 rounded-lg flex items-center space-x-4">
                <div className="image">
                  <svg
                    className="w-6 h-6"
                    xmlns="http://www.w3.org/2000/svg"
